...
create view CHURN.CUSTOMER_HISTORY_VIEW  as
...
DROP TABLE CHURN.CUSTOMER_HISTORY;

CREATE TABLE CHURN.CUSTOMER_HISTORY AS (
select * from CHURN.CUSTOMER_HISTORY_VIEW
) WITH NO DATA;

insert into  CHURN.CUSTOMER_HISTORY
select * from CHURN.CUSTOMER_HISTORY_VIEW;

select count(*) from CHURN.CUSTOMER_HISTORY; --returns 19251 records
